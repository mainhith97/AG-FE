...
@Component({
  ...
  styleUrls: ['./admin-create-product.component.scss', '../../../components/header/admin-header/admin-header.component.scss', '../../../components/sidebar/admin-sidebar/admin-sidebar.component.scss']
})
