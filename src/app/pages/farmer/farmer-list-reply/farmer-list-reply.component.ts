...
@Component({
  selector: 'app-farmer-list-reply',
  templateUrl: './farmer-list-reply.component.html',
  // tslint:disable-next-line: max-line-length
  styleUrls: ['./farmer-list-reply.component.scss', '../../../components/header/farmer-header/farmer-header.component.scss', '../../../components/sidebar/farmer-sidebar/farmer-sidebar.component.scss']
})
